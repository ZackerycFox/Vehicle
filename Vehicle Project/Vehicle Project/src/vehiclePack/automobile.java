...
public class automobile extends vehicle {
	...
	private vehicleModel automodel; 
		...
		automobile(int passengers, int fuelcap, int mpg, int doors, int tiresize, int year, int totalmiles, 
			int tonage, String color,  vehicleMake Toyota, vehicleModel Tacoma){
	...
	private void updateVehical() { 
		...
		//"Wheels", "4", "MPG", "28", "Color", "Burnt Orange", "Seats", "5", "Fuel Capacity", "18", "tonage", "1600"
		...
		try {
			...
			System.out.println("Bad Trim Package1");
		}
